...
class HydrationFragment : Fragment() {
    ...
    private val waterViewModel by lazy {
        WaterViewModel.WaterViewModelFactory((requireActivity().application as HydrationApplication).repository) // WaterViewModelFactory is given an application context.  In this case a HydrationApplication.  Cast of a child class to the superclass.
            .create(WaterViewModel::class.java)  // gives HydrationFragment a reference to the WaterViewModel
    }
    ...
    private fun addGlass() {
        // add 1 to total glasses - up to a max of 5
    ...
    companion object {  // allows newInstance function to be invoked without making a Fragment first
        /**
